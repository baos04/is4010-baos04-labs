...
def generate_mad_lib(adjective, noun, verb):
    ...
    """
    return f"Once upon a time, there was a {adjective} {noun}. This {noun} decided to {verb} through the enchanted forest. Everyone was amazed by how the {adjective} {noun} would {verb} with such grace and wonder!"
